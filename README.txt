...
models.py - includes all the models which will act as "resources" in our resource tree.
views.py - all the views goes to here.
schemas.py - schemas for pyramid_simpleform. All the form validation code goes here
interfaces.py - mostly for marker interfaces.
tests.py - all the tests. I'm trying to keep up 100% test-coverage.
config.py - (hardcode stuff. We should remove this after the project is finished)
__init__.py - configuration for our project.
